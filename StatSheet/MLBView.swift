...
class MLBView: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject!) {
        ...
        if (segue.identifier == "MLBSegue") {
            ...
            var url1 = "http://www.foxsports.com/mlb/" + new_player1name + "-player-stats"
            var url2 = "http://www.foxsports.com/mlb/" + new_player2name + "-player-stats"
