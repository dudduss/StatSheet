...
class NBAView: UIViewController, UITextFieldDelegate {
   ...
   override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject!) {
       ...
       if (segue.identifier == "NBAsegue") {
           ...
           var new_player1name = player1Name.text.stringByReplacingOccurrencesOfString(" ", withString: "-", options: NSStringCompareOptions.LiteralSearch, range: nil)
            ...
            var url1 = "http://www.foxsports.com/nba/" + new_player1name + "-player-stats"
            var url2 = "http://www.foxsports.com/nba/" + new_player2name + "-player-stats"
